...
public class FileDialog extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final Button quitButton = (Button) findViewById(R.id.fdButtonQuit);
		...
		// MRC: allow START_PATH to be a file, even if canSelectDir is false
		File file = new File(startPath);
		if(!file.isDirectory() || canSelectDir) {
			selectedFile = file;
